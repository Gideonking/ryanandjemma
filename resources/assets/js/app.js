...
$(function () {
	...
	Barba.Pjax.getTransition = function () {
		...
		if ($(clickedElem).hasClass('barba--totimeline')) trans = !desktopVer ? mobileTransitionToTimeline : desktopTransitionToTimeline;
		else if ($(clickedElem).hasClass('barba--fromtimeline')) trans = !desktopVer ? mobileTransitionFromTimeline : desktopTransitionFromTimeline;
		return trans;
	};
